    ...
    <section id="visit" className="max-w-7xl mx-auto px-6 py-28">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-16">
        ...
        <Reveal className="bento-card lg:col-span-2 p-10 flex flex-col justify-between">
          ...
          <a href="https://www.google.com/maps/dir/?api=1&destination=Cha+Kafe+Chinna+Waltair+Visakhapatnam&destination_place_id=ChIJJfiuuPlDOToRNJULM98N8eA" target="_blank" rel="noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open('https://www.google.com/maps/dir/?api=1&destination=Cha+Kafe+Chinna+Waltair+Visakhapatnam&destination_place_id=ChIJJfiuuPlDOToRNJULM98N8eA', '_blank'); }} className="cta-primary mt-8 justify-center">
        ...
        <Reveal className="bento-card lg:col-span-3 p-0 min-h-[400px] overflow-hidden" delay={0.1}>
          <div className="w-full h-full relative min-h-[400px]">
            <a href="https://www.google.com/maps/dir/?api=1&destination=Cha+Kafe+Chinna+Waltair+Visakhapatnam&destination_place_id=ChIJJfiuuPlDOToRNJULM98N8eA" target="_blank" rel="noopener noreferrer" onClick={(e) => { e.preventDefault(); window.open('https://www.google.com/maps/dir/?api=1&destination=Cha+Kafe+Chinna+Waltair+Visakhapatnam&destination_place_id=ChIJJfiuuPlDOToRNJULM98N8eA', '_blank'); }}
      ...
      <Reveal delay={0.5}>
        <div className="mt-8 text-center">
          <a
            href="https://www.google.com/maps/dir/?api=1&destination=Cha+Kafe+Chinna+Waltair+Visakhapatnam&destination_place_id=ChIJJfiuuPlDOToRNJULM98N8eA"
            onClick={(e) => { e.preventDefault(); window.open('https://www.google.com/maps/dir/?api=1&destination=Cha+Kafe+Chinna+Waltair+Visakhapatnam&destination_place_id=ChIJJfiuuPlDOToRNJULM98N8eA', '_blank'); }}
            target="_blank"
